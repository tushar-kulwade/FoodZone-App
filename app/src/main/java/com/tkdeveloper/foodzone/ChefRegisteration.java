...
public class ChefRegisteration extends AppCompatActivity {
    ...
    String[] Gujarat = {"Ahemdabad", "Vadodara", "Surat"};
    ...
    String[] Pune = {"Hinjewadi", "Wagholi", " Ambegaon", "Undri", "Katraj","Yerwada","VimanNagar","ChandanNagar","ShastriNagar",
             "Hadapsar","Kondhwa","Kalyani Nagar",};
